...
DNSServiceErrorType DNSSD_API DNSServiceReconfirmRecord(
    ...
    error = avahi_reconfirm_record(sdref->client, (AvahiIfIndex)interfaceIndex, AVAHI_PROTO_UNSPEC, fullname, rrtype, rrclass, rdata, rdlen, AVAHI_RECONFIRM_RECORD_NOFLAGS);
